...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    ...
    $values['stand'] = empty($_COOKIE['stand_value']) ? '' : $_COOKIE['stand_value'];
    ...
    try {
        ...
        $stand = $db->prepare("INSERT INTO powers SET powers = ?, user_id = ? ");
        $stand->execute(array($powers, $power_id));
